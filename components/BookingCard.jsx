...
const BookingCard = () => {
  return (
    <div id="booking" className="flex bg-6-1 h-[1000px] m-auto overflow-hidden shadow-sm font-decorative drop-shadow-sm/80 rounded-sm border-l-12 border-double border-white">
