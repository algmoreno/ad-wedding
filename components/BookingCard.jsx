...
const BookingCard = () => {
  return (
    <div id="booking" className="flex bg-6-1 mt-20 h-[700px] w-full m-auto overflow-hidden shadow-sm font-decorative drop-shadow-xl/50 rounded-sm border-8 border-double border-white">
        <div className="relative w-full">
            <div className="absolute max-w-3xl bg-6-1 inset-0 flex flex-col px-5 items-center justify-center text-white backdrop-blur-4xl drop-shadow-xl/90 text-center">
